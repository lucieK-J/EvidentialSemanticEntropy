...
class HuggingfaceModel(BaseModel):
    ...
    def predict(self, input_data, temperature, return_full=False):
        ...
        log_likelihoods_including_EOS = transition_scores[0].tolist() # last token necessary for evsme

        # return sliced_answer, log_likelihoods, last_token_embedding
        return sliced_answer, log_likelihoods, log_likelihoods_including_EOS, last_token_embedding # last token necessary for evsme
